...
3. [System Generated Fields](fields#system-generated-fields)
...
These are some of the fields that are automatically generated by the CCADB and cannot be manually edited.
...
<td>
<ul>
<li>Set to empty when the certificate is expired or revoked, or when the root certificate that the intermediate certificate chains up to is not included in any root stores.</li>
